...
กด "ปิดรอบ" แล้วระบบจะ **ล็อกยอดของรอบนั้นไว้** (snapshot) — แก้ปฏิทินร้าน
หรือใบลาย้อนหลังก็ไม่ทำให้ยอดที่จ่ายไปแล้วขยับ ถ้ายอดสดต่างจากที่ล็อก
ตารางสรุปจะขึ้นแถบเตือนพร้อมปุ่ม "ยึดยอดใหม่" 
