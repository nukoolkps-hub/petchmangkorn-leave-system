...
| การลา | สรุปลา | สรุปรายเดือนต่อคน + เกินโควต้า + ยอดหักรายคน/รวมทั้งเดือน |
...
**วันอาทิตย์ไม่มีโควต้าช่วย** — ลาวันอาทิตย์วันแรกก็หัก 500 บาททันที ·
...
แก้โควต้า/อัตราหักได้ที่ `src/constants.ts` → `BUSINESS_RULES`
